...
5. Write a function that displays all the names that have a rank in a given decade in alphabetical order.

6. Write a function to display all names that are getting more popular in every decade. The output must be sorted by name.

7. Write a function to display all names that are getting less popular in every decade. The output must be sorted by name.
'''
# find name
